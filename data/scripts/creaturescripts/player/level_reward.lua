local table = 
{
	...
	[30] = {type = "item", id = {2160, 2}, msg = "You win 2 crystal coins for reach the level 20!"},
	[40] = {type = "bank", id = {20000, 0}, msg = "Was deposited in your bank 20000 gold coins!"},
	[50] = {type = "addon", id = {136, 128}, msg = "You win the addon citizen full for reach the level 40!"},
	[60] = {type = "coin", id = {5, 0}, msg = "You win 5 coins for reach the level 50!"},
	[70] = {type = "mount", id = {2, 0}, msg = "You win the mount x!"},
}
