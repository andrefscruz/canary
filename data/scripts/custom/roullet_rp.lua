local config = {
    ...
    prizePool = {
        {itemId = 49629, count = {1, 1},   chance = 20000}, -- special sparkles (blue)
        {itemId = 49633, count = {1, 1},   chance = 20000}, -- divine sparkles (blue)
        {itemId = 49637, count = {1, 1},   chance = 20000}, -- mystic sparkles (blue)
    ...
    roulettePositions = {
        Position(31937, 32391, 4),
        Position(31938, 32391, 4),
        Position(31939, 32391, 4),
        Position(31940, 32391, 4), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(31941, 32391, 4),
        Position(31942, 32391, 4),
        Position(31943, 32391, 4),
    }
}
local function sendDiscordLog(player, item, count)
    local message = ":game_die: **" .. player:getName() .. "** won **" .. count .. "x " .. ItemType(item):getName() .. "** from the RP Roulette!"
