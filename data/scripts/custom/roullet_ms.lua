local config = {
    ...
    prizePool = {
        {itemId = 49630, count = {1, 1},   chance = 20000}, -- special sparkles (blue)
        {itemId = 49634, count = {1, 1},   chance = 20000}, -- divine sparkles (blue)
        {itemId = 49638, count = {1, 1},   chance = 20000}, -- mystic sparkles (blue)
    ...
    roulettePositions = {
        Position(31895, 32391, 4),
        Position(31896, 32391, 4),
        Position(31897, 32391, 4),
        Position(31898, 32391, 4), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(31899, 32391, 4),
        Position(31900, 32391, 4),
        Position(31901, 32391, 4),
    }
}
local function sendDiscordLog(player, item, count)
    local message = ":game_die: **" .. player:getName() .. "** won **" .. count .. "x " .. ItemType(item):getName() .. "** from the MS Roulette!"
