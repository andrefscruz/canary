local config = {
    ...
    prizePool = {
        {itemId = 49627, count = {1, 1},   chance = 20000}, -- special sparkles (blue)
        {itemId = 49631, count = {1, 1},   chance = 20000}, -- divine sparkles (blue)
    ...
    roulettePositions = {
        Position(31958, 32391, 4),
        Position(31959, 32391, 4),
        Position(31960, 32391, 4),
        Position(31961, 32391, 4), -- position 4 in this list is hard-coded to be the reward location, which is the item given to the player
        Position(31962, 32391, 4),
        Position(31963, 32391, 4),
        Position(31964, 32391, 4),
    }
}
local function sendDiscordLog(player, item, count)
    local message = ":game_die: **" .. player:getName() .. "** won **" .. count .. "x " .. ItemType(item):getName() .. "** from the ED Roulette!"
